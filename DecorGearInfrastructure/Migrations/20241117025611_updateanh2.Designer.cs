...
namespace DecorGearInfrastructure.Migrations
{
    ...
    [Migration("20241117025611_updateanh2")]
    partial class updateanh2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DecorGearDomain.Data.Entities.ImageList", b =>
                {
                    ...
                    b.HasIndex("KeyboardDetailID");

                    b.HasIndex("MouseDetailID");
            ...
            modelBuilder.Entity("DecorGearDomain.Data.Entities.ImageList", b =>
                {
                    b.HasOne("DecorGearDomain.Data.Entities.KeyboardDetail", "KeyboardDetail")
                        .WithMany("ImageLists")
                        .HasForeignKey("KeyboardDetailID")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("DecorGearDomain.Data.Entities.MouseDetail", "MouseDetail")
                        .WithMany("ImageLists")
                        .HasForeignKey("MouseDetailID")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("KeyboardDetail");

                    b.Navigation("MouseDetail");
                });
